  ...
  */
  public function rules()
  {
    return [
      ...
      "email" => ["max:255", "email", "required", "unique:users,email"],
      "password" => ["same:password-confirm", "min:8", "max:255", "required"],
  ...
  public function messages() {
    return [
      ...
      'password.requried' => 'A password is requried.',

      // Password Confirm
      'password-confirm.requried' => 'A password confirmation is requried.',
